...
LEADERBOARD_MODELS: list[str] = [
    ...
    # --- Added 2026-04-17: TSUBAME run unregistered models ---
...
MODEL_DISPLAY_NAMES: dict[str, str] = {
    ...
    "OpenGVLab/InternVL3_5-38B": "InternVL3.5-38B",
    "AIDC-AI/Ovis2-1B": "Ovis2-1B",
    "AIDC-AI/Ovis2-2B": "Ovis2-2B",
    "AIDC-AI/Ovis2-4B": "Ovis2-4B",
    "AIDC-AI/Ovis2-8B": "Ovis2-8B",
    "AIDC-AI/Ovis2-16B": "Ovis2-16B",
    "AIDC-AI/Ovis2-34B": "Ovis2-34B",
    "AIDC-AI/Ovis2.5-9B": "Ovis2.5-9B",
    "allenai/Molmo2-4B": "Molmo2-4B",
    "allenai/Molmo2-8B": "Molmo2-8B",
    "moonshotai/Kimi-VL-A3B-Instruct": "Kimi-VL-A3B-Instruct",
    "openbmb/MiniCPM-o-2_6": "MiniCPM-o-2_6",
}
