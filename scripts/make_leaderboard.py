...
BENCHMARK_METRICS = {
    "japanese-heron-bench": [
        "conv", "detail", "complex", "overall",
        "conv_rel", "detail_rel", "complex_rel", "overall_rel",
    ],
    "ja-vlm-bench-in-the-wild": [
        "rougel", "llm_as_a_judge",
    ],
    "ja-vg-vqa-500": [
        "rougel", "llm_as_a_judge",
    ],
    "jdocqa": [
        "yesno_exact", "factoid_exact", "numerical_exact", "open-ended_bleu", "overall"
    ],
    "ja-multi-image-vqa": [
        "rougel", "llm_as_a_judge",
    ],
    "jmmmu": [
        "Overall-Art and Psychology", "Design", "Music", "Psychology",
        "Overall-Business", "Accounting", "Economics", "Finance", "Manage", "Marketing",
        "Overall-Science", "Biology", "Chemistry", "Math", "Physics",
        "Overall-Health and Medicine", "Basic_Medical_Science", "Clinical_Medicine",
        "Diagnostics_and_Laboratory_Medicine", "Pharmacy", "Public_Health",
        "Overall-Tech and Engineering", "Agriculture", "Architecture_and_Engineering",
        "Computer_Science", "Electronics", "Energy_and_Power", "Materials",
        "Mechanical_Engineering", "Overall",
    ],
    "jic_vqa": [
        "jafacility20", "jaflower30", "jafood101", "jalandmark10", "average"
    ],
    "mecha-ja": [
        "overall", "Factoid", "Non-Factoid", "with_background", "without_background",
    ],
    "llava-bench-in-the-wild": [
        "rougel", "llm_as_a_judge",
    ],
    "mmmu": [
        "Overall-Art and Design", "Art", "Art_Theory", "Design", "Music",
        "Overall-Business", "Accounting", "Economics", "Finance", "Manage", "Marketing",
        "Overall-Science", "Biology", "Chemistry", "Geography", "Math", "Physics",
        "Overall-Health and Medicine", "Basic_Medical_Science", "Clinical_Medicine",
        "Diagnostics_and_Laboratory_Medicine", "Pharmacy", "Public_Health",
        "Overall-Humanities and Social Science", "History", "Literature", "Sociology", "Psychology",
        "Overall-Tech and Engineering", "Agriculture", "Architecture_and_Engineering",
        "Computer_Science", "Electronics", "Energy_and_Power", "Materials",
        "Mechanical_Engineering", "Overall",
    ],
    ...
    for task, metrics in MAIN_METRICS.items():
        for metric in metrics:
            ...
            if f"{task}-{metric}" in df.columns:
                ...
                main_df[f"{TASK_ALIAS[task]}-{METRIC_ALIAS[metric]}"] = df[f"{task}-{metric}"]
            else:
